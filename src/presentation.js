  ...
  render() {
    return (
      ...
      >
        ...
        <Slide bgImage={images.paralympics} controlColor="quartenary" progressColor="quartenary">
        ...
        <Slide bgImage={images.marcyDev} transition={['fade']} controlColor="primary" progressColor="primary">
          <Notes>
        ...
        <Slide bgImage={images.target} bgPosition="bottom center" transition={['fade']} controlColor="tertiary" progressColor="tertiary">
          <Notes>
        ...
        <Slide transition={["fade"]} bgColor="primary" bgImage={images.winning} bgColor="secondary" bgRepeat="no-repeat" bgSize="95% auto" progressColor="quartenary" controlColor="quartenary">
          <Notes>
        ...
        <Slide transition={["fade"]} bgImage={images.skiballet} controlColor="primary" progressColor="primary">
        ...
        <Slide bgImage={images.paralympics2} controlColor="primary" progressColor="primary">
